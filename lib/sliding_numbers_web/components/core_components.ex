defmodule SlidingNumbersWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(SlidingNumbersWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(SlidingNumbersWeb.Gettext, "errors", msg, opts)
    # end
